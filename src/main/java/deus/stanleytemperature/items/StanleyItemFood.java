...
public class StanleyItemFood extends ItemFood {
	...
	public StanleyItemFood(String name,int id, int healAmount, int ticksPerHeal, boolean favouriteWolfMeat, int maxStackSize, double sAmount, StanleyFoodType type) {
	...
	private void playSound(World world, EntityPlayer entityplayer, String soundEffect) {
